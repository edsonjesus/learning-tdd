...
public class StringCounterTest {
	...
	@Test
	public void letterOnSimpleSentence() throws InvalidAttributesException {
		assertEquals(2, counter.countOccurrences("Tester", "e"));
	}
	
	@Test
	public void letterOnComplexSentence() throws InvalidAttributesException {
		assertEquals(7, counter.countOccurrences("Honorificabilitudinitatibus", "i"));
	}
	
	@Test
	public void letterOnMoreThanOneSentences() throws InvalidAttributesException {
		assertEquals(3, counter.countOccurrences("Nothing else matters", "e"));
	}
	
	@Test
	public void letterWithTwoCharsOnValidSentence() throws InvalidAttributesException {
	...
	@Test
	public void letterWithThreeCharsOnValidSentence() throws InvalidAttributesException {
		thrown.expect(InvalidAttributesException.class);
		thrown.expectMessage("The letter must have only one character.");
	...
	@Test
	public void nullLetterOnValidSentence() throws InvalidAttributesException {
		thrown.expect(InvalidAttributesException.class);
	...
	@Test
	public void emptyLetterOnValidSentence() throws InvalidAttributesException {
		thrown.expect(InvalidAttributesException.class);
		thrown.expectMessage("The letter must have only one character.");
	...
	@Test
	public void anyLetterOnNullSentence() throws InvalidAttributesException {
		thrown.expect(InvalidAttributesException.class);
	...
	@Test
	public void anyLetterOnEmptySentence() throws InvalidAttributesException {
		thrown.expect(InvalidAttributesException.class);
